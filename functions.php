...
if (! defined('THEME_URI')) {
    // Replace the version number of the theme on each release.
    define('THEME_URI', get_template_directory_uri().'/assets');
}
...
function remian_in_scripts() {
    ...
    //script
    wp_enqueue_script(THEME_PREFIX.'-bootstrap.bundle.min', THEME_URI.'/bootstrap/js/bootstrap.min.js', [], _S_VERSION, true);
    wp_enqueue_script(THEME_PREFIX.'-jquery', THEME_URI.'/js/jquery.js', [], _S_VERSION, true);
    wp_enqueue_script(THEME_PREFIX.'-jquery.validate.min.js', THEME_URI.'/js/jquery.validate.min.js', [], _S_VERSION, true);
